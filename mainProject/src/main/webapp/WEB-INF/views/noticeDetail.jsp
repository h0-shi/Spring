	...
	<section class="page-section" id="detail">
		<div class="container">
			...
			<div class="card mb-4" style="min-height: 500px;">
				<div class="card-body">
					<div class="h2 title">${detail.ntitle }</div>
					<div class="row p-2 writerInfo">
						<div class="col align-middle text-start">${detail.mname } &ensp;
							<span class="clicks"><a href="noticeUpdate?no=${detail.nno }">수정</a> | <a href="javascript:void(0);" onclick="delCheck(${detail.nno})">삭제</a></span>
						</div>
						<div class="col align-middle text-end detailDate">${detail.ndate }</div>
					</div>
					<div class="mt-4 h-auto content">${detail.ncontent }</div>
				</div>
			</div>
